"""
mobile-analytics-api - Backend API
...
app = FastAPI(
    title="mobile-analytics-api",
    description="Mobile Analytics API: Mobile analytics collection API with event batching and dashboards",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "mobile-analytics-api"}
